 ...
 */
class CRM_Eventify_Upgrader_Base {

  /**
   * @var CRM_Eventify_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Eventify_Upgrader(
        'io.compuco.eventify',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Eventify_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Eventify_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
